...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2026/03/08 23:18:35 by lomartin          #+#    #+#             */
/*   Updated: 2026/03/09 13:31:06 by adastugu         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static inline float	get_current_refraction(t_object *objs, int obj_count,
		t_vect3 pos)
{
	int		i;
	...
	while (++i < obj_count)
	{
		...
		if (new_distance != -1 && new_distance < distance)
		{
			...
			current_refraction = objs[i].material.refraction;
		}
	}
